...
- **Money in.** If one of you put in $200 of the [starter budget](/blog/how-much-money-to-start-a-business-in-high-school) and the other put in $0, note it — but treat that as a loan to repay, not a reason to grab 15% of the company.
...
1. **Open a shared doc** titled "Founder Agreement — [Company Name]."
2. **List the founders** and the exact equity percentage each person gets. Make it add up to 100%.
3. **Write the vesting terms** — the period, the cliff, and "vests monthly" — in one sentence each.
4. **Define roles.** Who owns product, who owns customers, who has the final say when you disagree? Two "co-CEOs" who split every decision will stall; pick a tiebreaker for genuine deadlocks.
5. **Add a departure clause.** One line: "If a founder leaves, they keep only what has vested; unvested equity returns to the company."
6. **Write down how big decisions get made** — shutting down, adding a third founder, or entering a program like [an accelerator](/blog/what-happens-in-a-startup-accelerator).
7. **Both sign and date it.** Typed names and a date are fine for now. Save a copy each.
...
- **Bring in a neutral adult.** A [mentor](/blog/how-to-find-a-mentor-as-a-high-school-founder) or teacher who has no stake can referee a stuck split in ten minutes.
...
And if the real problem is that the partnership itself is shaky, read [How to Break Up With a Co-Founder](/blog/how-to-fire-or-leave-a-cofounder) before you scale anything — it's far easier to unwind a thin agreement than a real company.

## The mistakes that blow up later

- **The pure handshake.** "We're 50/50, we're best friends, we don't need a doc." This is exactly how best friends stop being friends. Write it down *because* you're close, not despite it — and if your co-founder is also your friend, [read this](/blog/how-to-work-with-a-cofounder-who-is-your-friend).
