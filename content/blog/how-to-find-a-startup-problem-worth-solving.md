...
Circle the three answers that gave you the strongest reaction. Those are your candidates. If you want more raw material, our list of [23 real business ideas for high school students](/blog/business-ideas-high-school-students) is built from exactly this kind of everyday problem.
...
This is what customer discovery is for, and it's a skill you can learn fast. Our [beginner's guide to customer interviews](/blog/customer-interviews-beginners-guide) walks through the exact questions to ask so people tell you the truth instead of being polite. Once a problem survives those conversations, you move into checking whether an idea to solve it actually holds up, which is what [validating a startup idea](/blog/how-to-validate-startup-idea-high-school) covers step by step.
