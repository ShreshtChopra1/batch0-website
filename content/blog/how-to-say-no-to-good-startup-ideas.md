...
- A live [landing page that actually converts](/blog/build-landing-page-that-converts) visitors into signups.
- Ten paying customers, or ten clear nos so you know the idea's dead.
- A real launch, not just a build. Shipping isn't the same as [actually launching](/blog/how-to-launch-a-product-on-social-media).
...
| Can you test it cheaply this week? | Needs money or a team you lack | You can [test it before building](/blog/how-to-test-business-idea-before-building) with a landing page and DMs |
...
This is the same muscle behind [knowing when to quit versus push through](/blog/how-to-know-when-to-quit-your-startup). Quitting on evidence is smart. Quitting on a whim is shiny object syndrome in disguise.
...
So pick your one thing. Park everything else. And the next time a shiny new idea shows up mid-project, don't ask whether it's good. Assume it is. Ask whether it's better than finishing what you started, then get back to work. When you've carried one company across the finish line, you'll have earned the right to pick the next one, and you can [apply that focus to something real](/apply).
